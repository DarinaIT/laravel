            ...
            <div class="row align-items-center">
                <div class="col-lg-6">
                    <div class="backg-content">
                        ...
                        <span class="backg-title wow soneFadeUp" data-wow-delay="0.5s">{{__('Tokens')}}</span>
                    </div>
                </div>
            </div>
        </div>
...
@if(count($team)>0)
<section class="teams-single wow soneFadeUp d-lg-block">
    <div class="container">
        <div class="section-title text-center">
            <h3 class="sub-title" style="color:{{$set->s_c}};">{{__('Tokens list')}}</h3>
