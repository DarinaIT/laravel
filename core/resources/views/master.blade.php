    ...
    <div class="scrollbar-inner">
      ...
      <div class="navbar-inner">
        ...
        <div class="collapse navbar-collapse" id="sidenav-collapse-main">
          ...
          <ul class="navbar-nav">
            <li class="nav-item">
              <a class="nav-link @if(route('admin.dashboard')==url()->current()) active @endif text-light" href="{{route('admin.dashboard')}}">
          ...
          <ul class="navbar-nav mb-md-3">
            <li class="nav-item">
              <a class="nav-link @if(route('admin.users')==url()->current()) active @endif text-light" href="{{route('admin.users')}}">
                <i class="fad fa-user" style="color: {{$set->s_c}};"></i>
                <span class="nav-link-text">{{__('Customers')}}</span>
              </a>
            </li>
            <li class="nav-item">
              <a class="nav-link @if(route('admin.ticket')==url()->current()) active @endif text-light" href="{{route('admin.ticket')}}">
                <i class="fad fa-user-headset" style="color: {{$set->s_c}};"></i>
                <span class="nav-link-text">{{__('Support ticket')}}</span>
              </a>
            </li>
            <li class="nav-item">
              <a class="nav-link @if(route('admin.promo')==url()->current()) active @endif text-light" href="{{route('admin.promo')}}">
                <i class="fad fa-envelope" style="color: {{$set->s_c}};"></i>
                <span class="nav-link-text">{{__('Promotional Emails')}}</span>
              </a>
            </li>
            <li class="nav-item">
              <a class="nav-link @if(route('admin.message')==url()->current()) active @endif text-light" href="{{route('admin.message')}}">
                <i class="fad fa-inbox" style="color: {{$set->s_c}};"></i>
                <span class="nav-link-text">{{__('Messages')}}</span>
              </a>
            </li>
			      <li class="nav-item">
              <a class="nav-link @if(route('admin.deposit.method')==url()->current() || route('admin.banktransfer')==url()->current() || route('admin.deposit.log')==url()->current()) active @endif text-light" href="#card" data-toggle="collapse" role="button" aria-expanded="false" aria-controls="navbar-examples">
              ...
              <div class="collapse @if(route('admin.deposit.method')==url()->current() || route('admin.banktransfer')==url()->current() || route('admin.deposit.log')==url()->current()) show @endif" id="card">
                <ul class="nav nav-sm flex-column">
			      ...
			      <li class="nav-item">
              <a class="nav-link @if(route('admin.withdraw.method')==url()->current() || route('admin.withdraw.log')==url()->current()) show @endif text-light" href="#xcard" data-toggle="collapse" role="button" aria-expanded="false" aria-controls="navbar-examples">
              ...
              <div class="collapse @if(route('admin.withdraw.method')==url()->current() || route('admin.withdraw.log')==url()->current()) show @endif" id="xcard">
                <ul class="nav nav-sm flex-column">
			      ...
			      <li class="nav-item">
              <a class="nav-link @if(route('admin.py.pending')==url()->current() || route('admin.py.completed')==url()->current() || route('admin.py.plans')==url()->current()|| route('admin.py.coupon')==url()->current()) show @endif text-light" href="#tcard" data-toggle="collapse" role="button" aria-expanded="false" aria-controls="navbar-examples">
            ...
            <li class="nav-item">
              <a class="nav-link @if(route('admin.transfers')==url()->current() || route('admin.referrals')==url()->current()) show @endif text-light" href="#trcard" data-toggle="collapse" role="button" aria-expanded="false" aria-controls="navbar-examples">
          ...
          <ul class="navbar-nav mb-md-3">
		  	    <li class="nav-item">
                <a class="nav-link @if(route('admin.blog')==url()->current() || route('admin.cat')==url()->current()) show @endif text-light" href="#brcard" data-toggle="collapse" role="button" aria-expanded="false" aria-controls="navbar-examples">
                  <i class="fad fa-newspaper" style="color: {{$set->s_c}};"></i>
            ...
            <li class="nav-item">
              <a class="nav-link @if(route('admin.currency')==url()->current()) active @endif text-light" href="{{route('admin.currency')}}">
                <i class="fad fa-money-bill-wave-alt" style="color: {{$set->s_c}};"></i>
                <span class="nav-link-text">{{__('Currency')}}</span>
              </a>
            </li>
            <li class="nav-item">
              <a class="nav-link @if(route('admin.setting')==url()->current()) active @endif text-light" href="{{route('admin.setting')}}">
            ...
            <li class="nav-item">
              <a class="nav-link" href="{{route('admin.logout')}}">
                <i class="fad fa-power-off" style="color: {{$set->s_c}};"></i>
                <span class="nav-link-text text-light">{{__('Log out')}}</span>
              </a>
            </li>
          </ul>
        </div>
