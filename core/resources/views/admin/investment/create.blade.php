                ...
                <div class="card">
                    ...
                    <div class="card-body">
                        ...
                        @csrf
                            ...
                            <div class="form-group row">
                                <label class="col-form-label col-lg-2">{{__('Comment:')}}</label>
                                <div class="col-lg-10">
                                    <input type="text" name="comment" class="form-control" reqiured>
                                </div>
                            </div>
                            <div class="form-group row">
                                <label class="col-form-label col-lg-2">{{__('Yield Percent')}}</label>
                                <div class="col-lg-10">
                            ...
                            <div class="form-group row">
                                <label class="col-form-label col-lg-2">{{__('Free product')}}</label>
                                <div class="col-lg-10">
                                    <select class="form-control select" name="free">
                                        <option value="1">{{__('Yes')}}
                                        </option>
                                        <option value="0">{{__('No')}}
                                        </option>
