            ...
            <form action="{{url('user/account')}}" method="post">
              @csrf
                ...
                <div class="form-group row">
                  ...
                  <div class="col-lg-9">
                    <input type="text" name="wallet" class="form-control" id="wallet" placeholder="{{__('Wallet Address')}}" value="{{$user->wallet}}">
                    <button name="connectMetamask" id="connectMetamask" type="button">Connect Metamask</button>
                  </div>
                </div>
