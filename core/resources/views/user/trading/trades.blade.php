              ...
              <div class="card">
                <div class="card-header checkx">
                  <div class="row align-items-center">
                    <div class="col-6">
                      <h4 class="mb-1 h4 text-dark er">{{$val->trx}}</h4>
                    </div>
                  ...
                  <div class="row align-items-center mb-1">
                    @if($val->status!=2)
                      <div class="col-12">
                        @if($val->recurring==1)
                          @if($val->c_r==1)
                          <a href="{{url('/')}}/user/cancel-recurring/{{$val->id}}" class="btn btn-sm btn-danger"><i class="fad fa-ban"></i> {{__('Cancel Recurring')}}</a>
                          @elseif($val->c_r==0)
                          <a href="{{url('/')}}/user/start-recurring/{{$val->id}}" class="btn btn-sm btn-success"><i class="fad fa-check"></i> {{__('Start Recurring')}}</a>
                          @endif
                        @endif
