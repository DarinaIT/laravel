         ...
         <div class="card">
           <div class="card-body">
             <div class="row align-items-center">
               <div class="col">
                 <h4 class="mb-1 text-dark">
                   <a href="{{route('user.bank_transfer')}}">{{__('Deposit BTBUSD')}}</a>
                   <button>btbusd</button>
                 </h4>
                </div>
             </div>
           </div>
        ...
        <div class="card">
          <div class="card-body">
            <div class="row align-items-center">
              <div class="col">
                <h4 class="mb-1 text-dark">
                  <a href="{{route('user.deposit_kudan')}}">{{__('Deposit Kudan Form')}}</a>
                  <button>deposit Kudan</button>
                </h4>
               </div>
            </div>
          </div>
